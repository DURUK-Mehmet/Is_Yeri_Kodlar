...
for i, tweet in enumerate(sntwitter.TwitterSearchScraper('from:parmakuclari').get_items()):  # change the search term here
...
tweets_df2.to_csv('parmakuclari.csv', index=False)  # write to csv the dataframe
